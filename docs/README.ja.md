...
5. **成果物の確認**: `📁 ローカルバックアップフォルダ` ボタンを押すと、変換されたマークダウンフォルダが開きます。
...
* **6か国語多国語対応**: 日本語、韓国어、英語、中国語、スペイン語、ドイツ語をネイティブサポートし、フォルダ選択画面のタイトルなども選択した言語に動的ローカライズされます。
* **高品質なマークダウン変換**:
